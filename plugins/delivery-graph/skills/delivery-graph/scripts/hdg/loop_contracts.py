...
_LOOP_EXECUTION_POLICY = {
    ...
    "progressReporting": {
        ...
        "progressPersistsEvent": True,
        "progressUpdatesLiveMonitor": True,
        "progressWritesProjection": False,
    ...
    "blockingToolCalls": {
        ...
        "estimateBeforeStart": True,
        "estimatedOverSecondsRequiresLeaseRequest": 60,
        "leaseRequestTool": "heartbeat_loop",
        "leaseRequestArgument": "expected_command_seconds",
        "preferSemanticChunks": True,
        "heartbeatBetweenChunks": True,
        "existingFileWholeRewriteDiscouraged": True,
        "singleBlockingCallRequiresCoveredLease": True,
    },
