...
PLANNING_TOOLS = (
    _tool(
        ...
        (
            ...
            "resume or manual-start continuation until the previous run is terminal or ready for "
    ...
    _tool(
        ...
        (
            ...
            "turn at a time. A later AUTOMATIC or MANUAL Delivery waits for a verifiable "
            ...
            "reservation before any branch transition. The frozen MANUAL snapshot "
