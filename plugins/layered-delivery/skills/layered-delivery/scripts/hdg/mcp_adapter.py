...
SERVER_INSTRUCTIONS = (
    ...
    "ephemeral host-native capacity and selectable-model facts, then "
    "returns analyzed model overrides or an explicitly reported current-"
    "executor fallback, plus concurrent assignments. The fallback remains "
    ...
    "Agent before that Agent claims with its actual Agent/model IDs and the "
    "verified decision fingerprint. The scheduler treats Loop payload and result "
