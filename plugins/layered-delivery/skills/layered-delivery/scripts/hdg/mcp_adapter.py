...
SERVER_INSTRUCTIONS = (
    ...
    "worktree session. Because Claude fixes CLAUDE_PROJECT_DIR when its MCP "
    ...
    "AUTOMATIC immediately prepares, freezes, and enters automatic dispatch "
    "without another confirmation; follow graph_frontier immediately. "
    ...
    "current language. Report immediately before and after a long-running "
    "test or build. LIGHT Loops report findings and final verification; a "
    ...
    "Graph authority. The result may include display-only workerTelemetry by "
