...
SERVER_INSTRUCTIONS = (
    ...
    "independent receiver. Advisory Skill hints use exact host-native wording "
    "when applicable and available, but remain skippable and never gate Loop "
...
CODEX_SERVER_INSTRUCTIONS = (
    ...
    "host-native receivers call dispatch_loop; pass any assignment "
    "receiverPrompt verbatim so applicable advisory Skill hints can be "
    "triggered natively. Never claim inline or expose "
